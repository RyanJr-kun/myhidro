  ...
  <div class="row">
    <div class="col-12">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <p>Di sini Anda dapat menampilkan tabel atau kartu yang berisi data tanaman hidroponik Anda.</p>
          {{-- TODO: Tambahkan tabel atau konten lain untuk manajemen tanaman --}}
        </div>
      </div>
    </div>
  </div>
