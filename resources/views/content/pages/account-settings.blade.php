  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="card mb-6">
        <!-- Account -->
        <div class="card-body">
          <div class="d-flex align-items-start align-items-sm-center gap-6 pb-4 border-bottom" id="form-upload">
            <img
            ...
            <div class="row g-6">
              ...
              <div class="col-md-6">
                ...
                <div class="input-group input-group-merge">
                  ...
                  <input type="text" id="nomerTelepon" name="nomer_telepon" class="form-control"
                    placeholder="812 3456 7890" value="{{ old('nomer_telepon', $user->nomer_telepon) }}" />
                </div>
              </div>
              <div class="col-12">
              ...
              <div class="mt-6">
                ...
                <button type="reset" class="btn btn-outline-secondary"
                  onclick="window.location.href='{{ route('account-settings') }}'">Cancel</button>
              </div>
          </form>
        </div>
        <!-- /Account -->
